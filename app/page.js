...
export default function Home() {
  return (
    <section className="h-full">
      <div className="container mx-auto xl:h-[70vh]">
        <div className="flex flex-col xl:flex-row items-center xl:pt-8 xl:pb-24 justify-between">
          <div className="order-2 xl:order-none text-center md:text-left">
            ...
            <p className="max-w-[800px] mb-9 text-white/80">I am interested and enthuerstic in web development though i am an Agriculturist. I an proficient in different language like python, javaScript and kotlin. Besides web development i have interest in the Artifical Intelligence.</p>
